                        ...
                        <div class="row">
                            ...
                            <div class="form-g col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bbb" class="form-control" id="formGroupExampleInput" placeholder="顆,個,公斤,公克...">
                                </div>
                                <div class="form-group">
                                    <label for="disabledSelect">每單位/熱量</label>
                                    <input type="text" name="heat" class="form-control" id="formGroupExampleInput" placeholder="500卡">
                                </div>
