...
@section("javascript")
    function showPreview(obj){
        if(obj.files && obj.files[0]){
            ...
            $("#userImage_img").attr('src', e.target.result);
        }
